          ...
          {!isTaskMasterInstalled && (
            <div className="bg-warm/10 dark:bg-warm/10 border border-warm/30 dark:border-warm/30 rounded-lg p-4">
              <div className="flex items-start gap-3">
                <div className="w-8 h-8 bg-warm/10 dark:bg-warm/10 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                  <svg className="w-4 h-4 text-warm dark:text-warm" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L4.082 16.5c-.77.833.192 2.5 1.732 2.5z" />
                  </svg>
                </div>
                <div className="flex-1">
                  <div className="font-medium text-warm dark:text-warm mb-2">
                    {t('tasks.notInstalled.title')}
                  </div>
                  <div className="text-sm text-warm dark:text-warm space-y-3">
                    <p>{t('tasks.notInstalled.description')}</p>

                    <div className="bg-warm/10 dark:bg-warm/10 rounded-lg p-3 font-mono text-sm">
